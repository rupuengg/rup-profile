...
class Educations extends React.Component{
  ...
  render(){
    ...
    return(
      <div id="lnkEducation" className="w3-container w3-card w3-white">
         <h2 className="w3-text-grey w3-padding-16"><i className="fa fa-glass fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Education Qualifications</h2>
         {educations}
      </div>
    );
  }
